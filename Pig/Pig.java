...
public class Pig {
	...
	if (beginsWithVowel(w))
	    return w + "way";
	else if ((! beginsWithVowel(w)) && (! beginsWithVowel(w.substring(1))))
	    return w.substring(2).toLowerCase() +w.substring(0,2).toLowerCase() + "ay";
	else
	    return w.substring(1).toLowerCase() + w.substring(0,1).toLowerCase() + "ay";
